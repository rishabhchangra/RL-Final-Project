...
class RepeatActionAndMaxFrame(gym.Wrapper):
    ...
    def __init__(self, env=None, repeat=4):
        ...
        # print("inside RepeatActionAndMaxFrame init")
    ...
    def step(self, action):
        ...
        for i in range(self.repeat):
            ...
            if done:
                break
        # print("inside RepeatActionAndMaxFrame step")
    ...
    def reset(self):
        ...
        # print("inside RepeatActionAndMaxFrame reset")
        return obs
...
class PreprocessFrame(gym.ObservationWrapper):
    def __init__(self, shape, env=None):
        ...
        # print("inside PreprocessFrame init")
    def observation(self, obs):
        ...
        # print("inside Preprocessing Observation")
        return new_obs
